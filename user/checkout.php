      ...
      <form action="/action_page.php">
        ...
        <div class="row">
          <div class="col-50">
            ...
            <input type="text" id="fname" name="firstname" placeholder="Mohd Ali Abu">
            <label for="email"><i class="fa fa-envelope"></i> Email</label>
            <input type="text" id="email" name="email" placeholder="Ali@example.com">
            <label for="address"><i class="fa fa-address-card-o"></i> Address</label>
            <input type="text" id="address" name="address" placeholder="Your Address">
            <label for="state"><i class="fa fa-institution"></i>City</label>
            ...
            <div class="row">
              ...
              <div class="col-50">
                ...
                <input type="text" id="country" name="country" placeholder="Malaysia">
              </div>
              <div class="col-50">
                <label for="postcode">Post Code</label>
                <input type="text" id="postcode" name="poscode" placeholder="10001">
              </div>
            </div>
          </div>
          ...
          <div class="col-50">
            ...
            <input type="text" id="cname" name="cardname" placeholder="Mohd Ali Abu">
